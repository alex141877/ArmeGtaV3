...
function createWeaponCard(weapon) {
    ...
    let stockDetail = '';
    if (weapon.qtyPropre > 0 && weapon.qtySale > 0) {
        stockDetail = `<div class="stock-detail"><span>${formatNumberWithSpaces(weapon.qtyPropre)} propre</span> · <span>${formatNumberWithSpaces(weapon.qtySale)} sale</span></div>`;
    }
